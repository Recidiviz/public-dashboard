...
const demographicsBoilerplate = `<p>${ageGroup} ${gender} ${raceOrEthnicityBoilerplateInline}</p>`;
...
const content: TenantContent = {
  ...
  ctaCopy: `At the <a href="https://www.docr.nd.gov" target="_blank" rel="noopener noreferrer">North Dakota Department of Corrections and Rehabilitation</a>, transparency is a critical element of our mission; sharing information builds greater accountability between the DOCR and the communities we serve.`,
  coBrandingCopy: `Produced in collaboration with <a href="https://www.docr.nd.gov">the North Dakota Department of Corrections and Rehabilitation</a>.`,
  feedbackUrl:
  ...
  metrics: {
    SentencePopulationCurrent: {
      ...
      methodology: `<p>This data includes all individuals that are currently incarcerated, on parole, or on probation
        in North Dakota.</p> ${demographicsBoilerplate} ${sentencingBoilerplate}`,
      totalLabel: "Total people sentenced",
    },
    SentenceTypesCurrent: {
      name: "Sentence Types",
      methodology: `<p>Incarceration includes any sentence that begins with a period of incarceration in a ND DOCR facility.
        Probation includes any sentence that begins with a period of probation under the supervision of a
        ND DOCR probation officer.</p> <p>Of note, individuals’ current status (incarcerated or on supervision)
    ...
    PrisonPopulationCurrent: {
      ...
      methodology: `<p>This data includes all individuals that are currently incarcerated in a ND DOCR facility.
    ...
    PrisonPopulationHistorical: {
      ...
      methodology: `<p>This data includes the number of people that were incarcerated in a ND DOCR facility on the
    ...
    ProbationPopulationCurrent: {
      ...
      methodology: `<p>This data includes people currently on probation in North Dakota.</p>
    ...
    ProbationRevocationsAggregate: {
      ...
      methodology: `<p>This data includes people who were incarcerated in a DOCR facility within the last
    ...
    ProbationProgrammingCurrent: {
      ...
      methodology: `<p>This data includes the total number of people on probation who are actively
        ...
        individuals are enrolled.</p> ${probationBoilerplate}`,
    },
    ProbationTerminationsHistorical: {
      ...
      methodology: `<p>
        ...
        probation in a given month out of all people whose probation was terminated that
        month.
      </p>
      <p>
        ...
        early discharge granted by the court. Unsuccessful completions of probation
    ...
    ParolePopulationCurrent: {
      ...
      methodology: `<p>This data includes people currently on parole in North Dakota.</p>
    ...
    ParolePopulationHistorical: {
      ...
      methodology: `<p>This data includes the number of people that were on parole in North Dakota
    ...
    ParoleRevocationsAggregate: {
      ...
      methodology: `<p>This data includes people who were incarcerated in a DOCR facility within the
    ...
    ParoleProgrammingCurrent: {
      ...
      methodology: `<p>This data includes the total number of people on parole who are actively enrolled
        ...
        regions of the provider locations at which individuals are enrolled.</p> ${paroleBoilerplate}`,
    },
  },
  systemNarratives: {
    Sentencing: {
    ...
    Probation: {
      ...
      sections: [
        ...
        },
        {
          ...
          metricTypeId: "ProbationTerminationsHistorical",
        },
        {
  ...
  localities: {
    ...
    Prison: {
      ...
      entries: [
        ...
        { id: "DEFP", label: "Deferred Prioritization" },
  ...
  racialDisparitiesNarrative: {
    ...
    introductionMethodology: `<p>${raceOrEthnicityBoilerplateInline}</p> ${supervisionBoilerplate}`,
    sections: {
      beforeCorrections: {
        ...
        methodology: `<p>The source of data for racial and ethnic proportions overall in
          ...
          ethnic group.</p><p>${raceOrEthnicityBoilerplateInline}</p>${supervisionBoilerplate}`,
      },
      sentencing: {
        ...
        methodology: `<p>Incarceration includes any sentence that begins with a period of incarceration in a
          ...
          supervision of a ND DOCR probation officer.</p>
          ...
          <p>${raceOrEthnicityBoilerplateInline}</p>${supervisionBoilerplate}`,
      },
      releasesToParole: {
      ...
      programming: {
        ...
        methodology: `<p>${raceOrEthnicityBoilerplateInline}</p>${supervisionBoilerplate}`,
      },
      conclusion: {
        title:
