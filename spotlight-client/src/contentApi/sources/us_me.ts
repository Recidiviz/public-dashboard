...
const content: TenantContent = {
  ...
  metrics: {
    SentencePopulationCurrent: {
      ...
      methodology: `<p>This data includes all individuals that are currently incarcerated or on probation
        in Maine.</p> ${demographicsBoilerplate} ${sentencingBoilerplate}`,
      totalLabel: "Total people sentenced",
    },
    SentenceTypesCurrent: {
      name: "Sentence Types",
      methodology: `<p>Incarceration includes any sentence that begins with a period of incarceration in a DOC facility.
        Probation includes any sentence that begins with a period of probation under the supervision of a
        DOC probation officer.</p> <p>Of note, individuals’ current status (incarcerated or on supervision)
    ...
    PrisonPopulationCurrent: {
      ...
      methodology: `<p>This data includes all individuals that are currently incarcerated in a DOC facility.
    ...
    PrisonPopulationHistorical: {
      ...
      methodology: `<p>This data includes the number of people that were incarcerated in a DOC facility on the
    ...
    ProbationPopulationCurrent: {
      ...
      methodology: `<p>This data includes people currently on probation in Maine.</p>
    ...
    ProbationPopulationHistorical: {
      ...
      methodology: `<p>This data includes the number of people that were on probation in
        Maine on the first day of each month over the last 20 years.</p>
    ...
    sections: {
      ...
      sentencing: {
        ...
        methodology: `<p>Incarceration includes any sentence that begins with a period of incarceration in a
          ...
          supervision of a DOC probation officer.</p>
